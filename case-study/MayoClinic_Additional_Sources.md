# Mayo Clinic Case Study: Additional Sources and Data
## ITEC-617 | Kogod School of Business, American University | Spring 2026

> **AI Methodology Disclaimer:** This document was developed with AI assistance (Claude Code)
> using the Agentic AI Case Study Development methodology. All quotes and data points have been
> sourced from publicly available materials and verified against original sources. T2 sources
> represent content verified through direct web access; T3 sources are flagged accordingly.

---

## Executive Summary

Research was conducted using publicly available sources: official press releases, trade
journalism, a National Academies of Sciences case study, and financial news reports.

**Source quality:** 5 T2 sources (partial text verified); 9 T3 sources (existence confirmed).

**Key themes:**
1. Dr. Halamka frames healthcare AI as a "perfect storm" opportunity
2. "Data under glass" governance model enables ethical data sharing
3. Mayo Clinic Platform evolved from concept (2019) to a 56-million-patient ecosystem (2024)
4. Microsoft and Google as strategic infrastructure partners
5. Tension between speed of AI innovation and patient safety/ethics requirements

---

## Exhibit 1: Executive Statements and Verified Quotes

### Dr. John Halamka, President, Mayo Clinic Platform

*Source: HealthLeaders Media, "John Halamka, MD, Launches Mayo Clinic's Digital Data Business" (2020) [T2 -- content verified through direct web fetch]*
...
*Source: CXOTalk, "Data and AI Improve Patient Outcomes at the Mayo Clinic" (2023) [T3 -- existence confirmed, full text inaccessible]*

On AI and physician augmentation:

> "If your doctor can be replaced by AI, then your doctor should be replaced by AI."

**Interpretive note:** Halamka uses this framing to argue that AI performing cognitive
pattern-matching frees physicians for uniquely human judgment -- not a literal call for
physician replacement. This quote is a strong discussion prompt precisely because it
requires students to examine context before interpretation.

---

### Cris Ross, Chief Information Officer, Mayo Clinic

*Source: Microsoft News, September 28, 2023 [T2 -- content verified through direct fetch]*

> "Privacy, ethics and safety are at the forefront of Mayo Clinic's work with generative AI and large language models."

---

### Dr. Gianrico Farrugia, President and CEO, Mayo Clinic

*Source: Fierce Healthcare, February 2024 (reporting 2023 performance) [T2]*

> "By every measure, Mayo Clinic made excellent progress in 2023 towards our goal of creating a better healthcare system."

*Source: PlatforMed 2024 conference proceedings, as reported June 2024 [T3]*

> "Platforms represent our greatest opportunity to bring real, lasting, and transformative change to our global healthcare system."
---

## Exhibit 2: Financial Data

### Mayo Clinic Financial Performance (2022-2023)

| Metric | 2022 | 2023 | YoY Change |
|--------|------|------|-----------|
| Total Revenue | $16.3B | $17.9B | +10.2% |
| Net Medical Service Revenue | ~$13.9B | $15.1B | +8.8% |
| Total Expenses | $15.7B | $16.9B | +7.4% |
| Staff Salaries and Benefits | ~$9.8B | $10.5B | +7.1% |
| Operating Income | ~$0.6B | $1.1B | +82% |
| Operating Margin | ~3.7% | 6.0% | +2.3 pp |
| Capital Expenditures | N/A | $1.18B | -- |
| Investment Income | N/A | $536M | -- |

*Sources: Fierce Healthcare (T2), Healthcare Dive (T3) -- February 2024*

### Operational Scale (2023)

| Metric | Value | Source |
|--------|-------|--------|
| New staff positions added | 14,000 | Fierce Healthcare (T2) |
| Clinical trials participated | 2,500 | Fierce Healthcare (T2) |
| Patients served | ~1.3 million | Fierce Healthcare (T2) |
| Countries of patient origin | 130+ | Fierce Healthcare (T2) |
| Total employees (2020 data) | 86,000 | HealthLeaders (T2) |

---

## Exhibit 3: Mayo Clinic Platform Growth

| Metric | 2022 | 2023 | 2024 |
|--------|------|------|------|
| Distributed data network partners | 1 (Mercy) | 4 | 9 |
| Patient lives represented | -- | ~27M | 56M |
| Continents covered | 1 | 3 | 4 |
| Solution developer ecosystem | -- | -- | 81 |
| Healthcare providers integrating solutions | -- | -- | 61 |

*Sources: Mayo Clinic News Network (T3); Becker's Hospital Review (T3)*
### Platform_Accelerate Startup Cohorts

| Cohort | Year | Companies | Notable Members |
|--------|------|-----------|----------------|
| 1st | 2022 | 4 | cliexa (cardiovascular AI), Quadrant Health (EHR triage), ScienceIO (data tools), Seer Medical (epilepsy diagnostics) |
| 2nd | Summer 2022 | 7 | AESOP Technology, Biotia, Dynocardia, ImpriMed, Predicta Med, SOAP Health (6 of 7 identified; 1 not named in public sources) |
| 3rd-5th | 2023-2025 | 30+ | C the Signs (UK cancer prediction), various clinical AI startups |
| **Total** | **2022-2025** | **45+** | -- |

---

## Exhibit 4: Key Strategic Partnerships

### Partnership 1: Google Cloud (September 2019)

| Element | Detail |
|---------|--------|
| Announced | September 2019 |
| Duration | 10-year agreement |
| Purpose | Design framework for ethical secondary use of clinical data |
| Google Office | New Rochester, MN office for joint collaboration |
| Data Model | "Data under glass" -- federated learning, data never leaves Mayo |
| De-identification | Structured: Jan-Apr 2020; Unstructured: Apr-Aug 2020 |
| Governance | "One Table" task force; DaTA Board (2021, 11 members) |
| Records centralized | 1.2 million patient records in Mayo Clinic Cloud |

*Source: NCBI / National Academies of Sciences (2023) [T2]*

### Partnership 2: Microsoft (September 2023)

| Element | Detail |
|---------|--------|
| Announced | September 28, 2023 |
| Program | Microsoft 365 Copilot Early Access Program |
| Participants | Hundreds of clinical staff, doctors, healthcare workers |
| Focus | Administrative automation: form-filling, documentation, scheduling |
...
|------|-------|------------|
| Dec 2019 | Dr. Halamka named President, Mayo Clinic Platform | T3 |
| Jan 1, 2020 | Halamka presidency commences | T2 (Wikipedia) |
| Jan-Apr 2020 | De-identification of structured data in Google enclave | T2 (NCBI) |
| Apr-Aug 2020 | De-identification of unstructured data completed | T2 (NCBI) |
| 2020 | Halamka elected to National Academy of Medicine | T2 (Wikipedia) |
| 2021 | DaTA Board created with 11 community members | T2 (NCBI) |
| 2022 Q1 | Platform_Accelerate launches, first cohort (4 companies) | T3 |
| 2022 Q3 | Platform_Accelerate second cohort (7 companies) | T3 |
| May 2023 | Data network expands: Brazil, Israel, Canada partners added | T3 |
| Sept 28, 2023 | Microsoft 365 Copilot Early Access announced with Mayo | T2 |
| 2023 FY | Mayo reports $17.9B revenue; $1.1B operating income (+82% YoY) | T2 |
| Mar 2024 | FDA clears ELEFT (co-developed with Mayo) | T3 |
| Jun 2024 | PlatforMed 2024: 56M patient lives, 81 solution developers | T3 |
| 2024 | Data network grows to 9 partners across 4 continents | T3 |
| Jan 2025 | Mayo + Microsoft Research + Cerebras: foundation model collaboration | T3 |

---

## Exhibit 6: AI Clinical Algorithms

| Algorithm | Clinical Purpose | Status | Source |
|-----------|-----------------|--------|--------|
| Colonoscopy error reduction | Reduces polyp miss rate to 3% error | Deployed | T3 |
| Atrial fibrillation prediction | Identifies patients likely to develop AF | Deployed | T3 |
| Prediabetes identification | Flags at-risk patients from EHR patterns | Deployed | T3 |
| Colorectal cancer 10-year risk | Predicts CRC risk without prior disease history | Deployed | T3 |
| ELEFT (Eko Health stethoscope) | Detects low ejection fraction via AI | FDA cleared Mar 2024 | T3 |
| Multimodal radiology AI | Auto-generates chest X-ray reports | In development | T3 |
---

## Exhibit 7: Dr. John Halamka -- Biographical Profile

| Category | Detail | Source |
|----------|--------|--------|
| Born | 1968, Des Moines, Iowa | Wikipedia (T2) |
| Education | Stanford: Public Policy and Medical Microbiology (1984) | Wikipedia (T2) |
| MD/PhD | Joint UCSF/UC Berkeley program, 1984-1993 | Wikipedia (T2) |
| Residency | Emergency Medicine, Harbor-UCLA Medical Center, 1993-1996 | Wikipedia (T2) |
| Fellowship | Medical Informatics, Harvard/MIT, 1997 | Wikipedia (T2) |
| Prior Leadership | CIO, Beth Israel Deaconess Medical Center (20 years) | HealthLeaders (T2) |
| Harvard Faculty | International Healthcare Innovation Professor | HealthLeaders (T2) |
| Early Entrepreneurship | Founded Ibis Research Labs, 1981 (sold 1992) | Wikipedia (T2) |
| Current Role | President, Mayo Clinic Platform (Jan 1, 2020-present) | Wikipedia (T2) |
| Academy | Elected, National Academy of Medicine, 2020 | Wikipedia (T2) |
| Publications | 8 books on healthcare IT and clinical informatics | Wikipedia (T2) |
| Clinical Practice | Still practices emergency medicine | Wikipedia (T2) |

---

## Exhibit 8: Competitive Landscape

| Organization | Approach | Key Differentiator | Notes |
|-------------|---------|-------------------|-------|
| Mayo Clinic Platform | Federated data enclave; startup accelerator; tech partnerships | Brand trust + federated governance | 56M patient lives (2024) |
| Epic Systems | EHR-native AI; App Orchard marketplace | Dominant EHR market share | 250M+ patient records |
| Google Health | Cloud infrastructure + Med-PaLM 2 | Foundation model capabilities | Multiple health system clients |
| Microsoft Azure Health | Azure cloud + Copilot; M365 integration | Productivity tools + OpenAI partnership | Enterprise-wide adoption |
| IBM Watson Health | AI diagnostics and oncology (sold 2022) | Warning case: claims outpaced validation | Divested to Francisco Partners 2022 |
